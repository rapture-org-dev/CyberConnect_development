  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await onAdd({
        ...
        github_repos: repos,
      } as Partial<Project> & { github_repos?: string[] });
      onClose();
    } catch (err: any) {
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <ProjectGitHubReposEditor values={githubRepos} onChange={setGithubRepos} />
          ...
          <button
            ...
            } disabled:opacity-50 text-white rounded-xl font-medium text-sm transition-all shadow-lg`}
          >
            {isCreating ? (
              <>
